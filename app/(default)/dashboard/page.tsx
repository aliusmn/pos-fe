  ...
  return (
    <div className="flex w-full justify-end">
      <Transition show={openSidebar}>
        <aside className="w-2/12 border-r border-gray-200 h-screen bg-indigo-600 text-white text-sm font-medium transition duration-300 ease-in-out data-[closed]:opacity-0">
          ...
          <nav className="p-4 overflow-y-scroll scrollbar scrollbar-thumb-indigo-400 scrollbar-track-indigo-400 scrollbar-thin h-[calc(100%-80px)]">
            <section className="mb-6">
              <ul>
                <li className="px-4 py-2 hover:bg-indigo-700 my-1 bg-indigo-700 rounded-lg">
                  <Link
                    href="/dashboard"
                ...
                <li className="px-4 py-2 hover:bg-indigo-700 my-1 rounded-lg">
                  <Link
                    href="/products"
                    className="flex items-center space-x-4"
                  >
            ...
            <section className="mb-6">
              <p className="px-4 py-2 text-xs font-bold">Dukungan</p>
              <ul>
                <li className="px-4 py-2 hover:bg-indigo-700 my-1 rounded-lg">
                  <Link
                    href="/dashboard"
            ...
            >
              ...
              <MenuItem>
                ...
                >
                  ...
                  <span className="ml-2 text-sm">Pengaturan</span>
                </Link>
              </MenuItem>
